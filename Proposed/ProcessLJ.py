...
if __name__ == "__main__":
    ...
    name = "ljspeech"
    in_dir = "/DoChangeYourDirectoryHere/LJSpeech-1.1"
    out_dir = "/DoChangeYourDirectoryHere/LJSpeechProcess"
    preset = "./mycheckpoint/20180510_mixture_lj_checkpoint_step000320000_ema.json"


    num_workers = None
    num_workers = cpu_count() if num_workers is None else int(num_workers)-2
    hparams2 = ""

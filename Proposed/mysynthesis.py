...
import sys
import os
from os.path import dirname, join, basename, splitext, split
import torch
import numpy as np
...
def wavegen(model, length=None, c=None, g=None, initial_value=None,
    ...
    """
    from trainWaveNet import sanity_check
...
if __name__ == "__main__":
    ...
    conditional_path = "/DoChangeYourDirectoryHere/LJSpeechProcess/ljspeech-mel-00001.npy"
    speaker_id = None

    # checkpoint_path = "../mycheckpoint/20180212_mixture_multispeaker_cmu_arctic_checkpoint_step000740000_ema.pth"
    # preset = "../mycheckpoint/20180212_multispeaker_cmu_arctic_mixture.json"
    # conditional_path = "../../CMUArcticProcess/cmu_arctic-mel-00005.npy"
    # speaker_id = 0
    ...
    dst_wav_path = join(dst_dir, "{}_{}.wav".format(file_name, time_suffix))
